...
import { ProvenanceRoutes } from './worker/http/routes/ProvenanceRoutes.js';
import { DashboardRoutes } from './worker/http/routes/DashboardRoutes.js';
import { ObservationRoutes } from './worker/http/routes/ObservationRoutes.js';
...
export class WorkerService implements WorkerRef {
  ...
  private registerRoutes(): void {
    ...
    this.server.registerRoutes(new ProvenanceRoutes(this.dbManager));
    this.server.registerRoutes(new DashboardRoutes(this.dbManager));
    this.server.registerRoutes(new ObservationRoutes(this.dbManager));
