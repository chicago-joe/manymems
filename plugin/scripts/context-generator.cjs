"use strict";var $t=Object.create;var G=Object.defineProperty;var Ht=Object.getOwnPropertyDescriptor;var Xt=Object.getOwnPropertyNames;var Gt=Object.getPrototypeOf,Bt=Object.prototype.hasOwnProperty;var jt=(r,e)=>{for(var t in e)G(r,t,{get:e[t],enumerable:!0})},Re=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Xt(e))!Bt.call(r,n)&&n!==t&&G(r,n,{get:()=>e[n],enumerable:!(s=Ht(e,n))||s.enumerable});return r};var U=(r,e,t)=>(t=r!=null?$t(Gt(r)):{},Re(e||!r||!r.__esModule?G(t,"default",{value:r,enumerable:!0}):t,r)),Wt=r=>Re(G({},"__esModule",{value:!0}),r);var Rs={};jt(Rs,{generateContext:()=>be});module.exports=Wt(Rs);var kt=U(require("path"),1),Pt=require("os"),Ft=require("fs");var ae=require("bun:sqlite");var T=require("path"),re=require("os"),D=require("fs");var Ae=require("url");var L=require("fs"),Oe=require("path");var qt=null;function Vt(r){return(qt??process.stderr.write.bind(process.stderr))(r)}function ee(r){Vt(r)}var te=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(te||{}),se=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Oe.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=te[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=te[e].padEnd(5),d=t.padEnd(6),u="";n?.correlationId?u=`[${n.correlationId}] `:n?.sessionId&&(u=`[session-${n.sessionId}] `);let c="";if(o!=null)if(o instanceof Error)c=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{c=`
`+JSON.stringify(o,null,2)}catch{c=" "+this.formatData(o)}else c=" "+this.formatData(o);let E="";if(n){let{sessionId:p,memorySessionId:f,correlationId:h,...m}=n;Object.keys(m).length>0&&(E=` {${Object.entries(m).map(([S,b])=>`${S}=${b}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${u}${s}${E}${c}`;if(this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),c=u?`${u[1].split("/").pop()}:${u[2]}`:"unknown",E={...s,location:c};return this.warn(e,`[HAPPY-PATH] ${t}`,E,n),o}},_=new se;var rs={};function Yt(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Ae.fileURLToPath)(rs.url))}var Kt=Yt();function Jt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,T.join)((0,re.homedir)(),".claude-mem"),e=(0,T.join)(r,"settings.json");try{if((0,D.existsSync)(e)){let t=JSON.parse((0,D.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var R=Jt(),M=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,re.homedir)(),".claude"),Ds=(0,T.join)(M,"plugins","marketplaces","thedotmack"),Qt=(0,T.join)(R,"archives"),zt=(0,T.join)(R,"logs"),Zt=(0,T.join)(R,"trash"),es=(0,T.join)(R,"backups"),ts=(0,T.join)(R,"modes"),Ms=(0,T.join)(R,"settings.json"),Ne=(0,T.join)(R,"claude-mem.db"),ss=(0,T.join)(R,"vector-db"),Ce=(0,T.join)(R,"observer-sessions"),ne=(0,T.basename)(Ce),ys=(0,T.join)(M,"settings.json"),Us=(0,T.join)(M,"commands"),xs=(0,T.join)(M,"CLAUDE.md");function Ie(r){(0,D.mkdirSync)(r,{recursive:!0})}function Le(){return(0,T.join)(Kt,"..")}var x={dataDir:()=>R,workerPid:()=>(0,T.join)(R,"worker.pid"),serverBetaPid:()=>(0,T.join)(R,".server-beta.pid"),serverBetaPort:()=>(0,T.join)(R,".server-beta.port"),serverBetaRuntime:()=>(0,T.join)(R,".server-beta.runtime.json"),settings:()=>(0,T.join)(R,"settings.json"),database:()=>(0,T.join)(R,"claude-mem.db"),chroma:()=>(0,T.join)(R,"chroma"),combinedCerts:()=>(0,T.join)(R,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(R,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(R,"transcript-watch-state.json"),corpora:()=>(0,T.join)(R,"corpora"),supervisorRegistry:()=>(0,T.join)(R,"supervisor.json"),envFile:()=>(0,T.join)(R,".env"),logsDir:()=>zt,archives:()=>Qt,trash:()=>Zt,backups:()=>es,modes:()=>ts,vectorDb:()=>ss,observerSessions:()=>Ce};function ve(r,e,t){if(t!=null){let n=r.prepare("SELECT id FROM user_prompts WHERE content_session_id = ? AND prompt_number = ? LIMIT 1").get(e,t);if(n)return n.id}return r.prepare("SELECT id FROM user_prompts WHERE content_session_id = ? ORDER BY prompt_number DESC LIMIT 1").get(e)?.id??null}function De(r,e){if(e.length===0)return 0;let t=r.prepare(`
  ...
  `,a=[t,...e];s!=null&&a.push(s);let d=r.prepare(i).run(...a);return Number(d.changes??0)}function Ue(r,e,t){let s=r.prepare(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,u=s==="relevance",c=u?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,E=n?`LIMIT ${n}`:"",g=e.map(()=>"?").join(","),p=[...e],f=[];if(o&&(f.push("project = ?"),p.push(o)),i)if(Array.isArray(i)){let b=i.map(()=>"?").join(",");f.push(`type IN (${b})`),p.push(...i)}else f.push("type = ?"),p.push(i);if(a){let b=Array.isArray(a)?a:[a],O=b.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");p.push(...b),f.push(`(${O.join(" OR ")})`)}if(d){let b=Array.isArray(d)?d:[d],O=b.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");b.forEach(v=>{p.push(`%${v}%`,`%${v}%`)}),f.push(`(${O.join(" OR ")})`)}let h=f.length>0?`WHERE id IN (${g}) AND ${f.join(" AND ")}`:`WHERE id IN (${g})`,A=this.db.prepare(`
      SELECT *
      FROM observations
      ${h}
      ${c}
      ${E}
    `).all(...p);if(!u)return A;let S=new Map(A.map(b=>[b.id,b]));return e.map(b=>S.get(b)).filter(b=>!!b)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=as(n,o),u=d.platformSource??N,c=this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),u=new Date(d).toISOString(),c=W(e,s.title,s.narrative),g=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(c.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let u=a??Date.now(),c=new Date(u).toISOString();return this.db.transaction(()=>{let g=[],p=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),f=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let m of s){let A=W(e,m.title,m.narrative),S=p.get(e,t,m.type,m.title,m.subtitle,JSON.stringify(m.facts),m.narrative,JSON.stringify(m.concepts),JSON.stringify(m.files_read),JSON.stringify(m.files_modified),o||null,i,m.agent_type??null,m.agent_id??null,m.agent_tool_id??null,m.visibility??"private",A,c,u,d||null);if(S){g.push(S.id);continue}let b=f.get(e,A);if(!b)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${A}`);g.push(b.id)}let h=null;if(n){let A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,c,u);h=Number(A.lastInsertRowid)}return{observationIds:g,summaryId:h,createdAtEpoch:u}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,u,c){let E=u??Date.now(),g=new Date(E).toISOString();return this.db.transaction(()=>{let f=[],h=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id,
         agent_tool_id, visibility, content_hash, created_at, created_at_epoch,
    ...
    `).all(...c);if(!i)return p;let f=new Map(p.map(h=>[h.id,h]));return e.map(h=>f.get(h)).filter(h=>!!h)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),c=[...e],E=o?"AND s.project = ?":"";o&&c.push(o);let p=this.db.prepare(`
      ...
      ${a}
      ${d}
    `).all(...c);if(!i)return p;let f=new Map(p.map(h=>[h.id,h]));return e.map(h=>f.get(h)).filter(h=>!!h)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,u;if(e!==null){let m=`
      ...
      `,A=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let S=this.db.prepare(m).all(t,...a,s),b=this.db.prepare(A).all(t,...a,n+1);if(S.length===0&&b.length===0)return{observations:[],sessions:[],prompts:[]};d=S.length>0?S[S.length-1].created_at_epoch:t,u=b.length>0?b[b.length-1].created_at_epoch:t}catch(S){return S instanceof Error?_.error("DB","Error getting boundary timestamps",{project:o},S):_.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(S))),{observations:[],sessions:[],prompts:[]}}}let c=`
      SELECT *
      FROM observations
  ...
  `).all(...e,...e,...s,...o,t.totalObservationCount)}function Ve(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t.sessionCount+le)}function Ye(r){return r.replace(/[/.]/g,"-")}function us(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(je,"").trim(),t)return t}return null}function cs(r){for(let e=r.length-1;e>=0;e--)try{let t=us(r[e]);if(t)return t}catch(t){t instanceof Error?_.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):_.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function ms(r){try{if(!(0,J.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,J.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{userMessage:"",assistantMessage:cs(t)}}catch(e){return e instanceof Error?_.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):_.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{userMessage:"",assistantMessage:""}}}function pe(r,e,t,s){if(!e.showLastMessage||r.length===0)return{userMessage:"",assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{userMessage:"",assistantMessage:""};let o=n.memory_session_id,i=Ye(s),a=We.default.join(M,"projects",i,`${o}.jsonl`);return ms(a)}function Ke(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Ee(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function Je(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function Qe(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function ze(r){return[`# [${r}] recent context, ${Qe()}`,""]}function Ze(){return[`Legend: \u{1F3AF}session ${C.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Layer 1 (this index): Compact ~50t/row \u2014 scan titles, pick relevant IDs","Layer 2: timeline([ID]) \u2014 narrative context around a session","Layer 3: get_observations([IDs]) \u2014 full details ~300-500t each","Search: mem-search skill",""]}function et(){return[]}function tt(){return[]}function st(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function rt(r){return[`### ${r}`]}function nt(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function ot(){return["| ID | Time | T | Title | Tokens |","|----|------|---|-------|--------|"]}function it(r,e,t){let s=r.title||"Untitled",n=C.getInstance().getTypeIcon(r.type),o=e?nt(e):'"',i=F(r);return`| #${r.id} | ${o} | ${n} | ${s} | ~${i} |`}function at(r,e,t,s){let n=[],o=r.title||"Untitled",i=C.getInstance().getTypeIcon(r.type),a=e?nt(e):'"',{readTokens:d,discoveryDisplay:u}=$(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let c=[];return s.showReadTokens&&c.push(`~${d}t`),s.showWorkTokens&&c.push(u),c.length>0&&n.push(c.join(" ")),n.push(""),n}function dt(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function H(r,e){return e?[`**${r}**: ${e}`,""]:[]}function _t(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function lt(r,e){let t=Math.round(r/1e3),s=Math.round(e/1e3);return["",`Access ${t}k tokens of past work (~${s}k read) via get_observations([IDs]) or mem-search skill.`]}function ut(r){return`# [${r}] recent context, ${Qe()}

No previous sessions found.`}function ct(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function mt(r){return["",`${l.bright}${l.cyan}[${r}] recent context, ${ct()}${l.reset}`,`${l.gray}${"\u2500".repeat(60)}${l.reset}`,""]}function pt(){let e=C.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${l.dim}Legend: session-request | ${e}${l.reset}`,""]}function Et(){return[`${l.bright}Column Key${l.reset}`,`${l.dim}  Read: Tokens to read this observation (cost to learn it now)${l.reset}`,`${l.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${l.reset}`,""]}function gt(){return[`${l.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${l.reset}`,"",`${l.dim}When you need implementation details, rationale, or debugging context:${l.reset}`,`${l.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${l.reset}`,`${l.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${l.reset}`,`${l.dim}  - Trust this index over re-reading code for past decisions and learnings${l.reset}`,""]}function Tt(r,e){let t=[];if(t.push(`${l.bright}${l.cyan}Context Economics${l.reset}`),t.push(`${l.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${l.reset}`),t.push(`${l.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${l.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${l.green}${s}${l.reset}`)}return t.push(""),t}function ft(r){return[`${l.bright}${l.cyan}${r}${l.reset}`,""]}function bt(r){return[`${l.dim}${r}${l.reset}`]}function ht(r,e,t,s){let n=r.title||"Untitled",o=C.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=$(r,s),u=t?`${l.dim}${e}${l.reset}`:" ".repeat(e.length),c=s.showReadTokens&&i>0?`${l.dim}(~${i}t)${l.reset}`:"",E=s.showWorkTokens&&a>0?`${l.dim}(${d} ${a.toLocaleString()}t)${l.reset}`:"";return`  ${l.dim}#${r.id}${l.reset}  ${u}  ${o}  ${n} ${c} ${E}`}function St(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=C.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:u,workEmoji:c}=$(r,n),E=t?`${l.dim}${e}${l.reset}`:" ".repeat(e.length),g=n.showReadTokens&&d>0?`${l.dim}(~${d}t)${l.reset}`:"",p=n.showWorkTokens&&u>0?`${l.dim}(${c} ${u.toLocaleString()}t)${l.reset}`:"";return o.push(`  ${l.dim}#${r.id}${l.reset}  ${E}  ${a}  ${l.bright}${i}${l.reset}`),s&&o.push(`    ${l.dim}${s}${l.reset}`),(g||p)&&o.push(`    ${g} ${p}`),o.push(""),o}function Rt(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${l.yellow}#S${r.id}${l.reset} ${t}`,""]}function X(r,e,t){return e?[`${t}${r}:${l.reset} ${e}`,""]:[]}function Ot(r){return r.assistantMessage?["","---","",`${l.bright}${l.magenta}Previously${l.reset}`,"",`${l.dim}A: ${r.assistantMessage}${l.reset}`,""]:[]}function At(r,e){let t=Math.round(r/1e3);return["",`${l.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${l.reset}`]}function Nt(r){return`
${l.bright}${l.cyan}[${r}] recent context, ${ct()}${l.reset}
${l.gray}${"\u2500".repeat(60)}${l.reset}

${l.dim}No previous sessions found for this project yet.${l.reset}
`}function Ct(r,e,t,s){let n=[];return s?n.push(...mt(r)):n.push(...ze(r)),s?n.push(...pt()):n.push(...Ze()),s?n.push(...Et()):n.push(...et()),s?n.push(...gt()):n.push(...tt()),K(t)&&(s?n.push(...Tt(e,t)):n.push(...st(e,t))),n}var ge=U(require("path"),1);function Z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Te(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function fe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Lt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function It(r,e){return ge.default.isAbsolute(r)?ge.default.relative(e,r):r}function vt(r,e,t){let s=Z(r);if(s.length>0)return It(s[0],e);if(t){let n=Z(t);if(n.length>0)return It(n[0],e)}return"General"}function ps(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Lt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Dt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?Z(r.facts).join(`
`):null}function Es(r,e,t,s){let n=[];n.push(...rt(r)),e.some(a=>a.type==="observation"&&!t.has(a.data.id))&&n.push(...ot());let i="";for(let a of e)if(a.type==="summary"){let d=a.data,u=Te(d.displayTime);n.push(...dt(d,u))}else{let d=a.data,u=fe(d.created_at),E=u!==i?u:"";if(i=u,t.has(d.id)){let p=Dt(d,s);n.push(...at(d,E,p,s))}else n.push(it(d,E,s))}return n}function gs(r,e,t,s,n){let o=[];o.push(...ft(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let u=d.data,c=Te(u.displayTime);o.push(...Rt(u,c))}else{let u=d.data,c=vt(u.files_modified,n,u.files_read),E=fe(u.created_at),g=E!==a;a=E;let p=t.has(u.id);if(c!==i&&(o.push(...bt(c)),i=c),p){let f=Dt(u,s);o.push(...St(u,E,g,f,s))}else o.push(ht(u,E,g,s))}return o.push(""),o}function Ts(r,e,t,s,n,o){return o?gs(r,e,t,s,n):Es(r,e,t,s)}function Mt(r,e,t,s,n){let o=[],i=ps(r);for(let[a,d]of i)o.push(...Ts(a,d,e,t,s,n));return o}function yt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Ut(r,e){let t=[];return e?(t.push(...X("Investigated",r.investigated,l.blue)),t.push(...X("Learned",r.learned,l.yellow)),t.push(...X("Completed",r.completed,l.green)),t.push(...X("Next Steps",r.next_steps,l.magenta))):(t.push(...H("Investigated",r.investigated)),t.push(...H("Learned",r.learned)),t.push(...H("Completed",r.completed)),t.push(...H("Next Steps",r.next_steps))),t}function xt(r,e){return e?Ot(r):_t(r)}function wt(r,e,t){return!K(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?At(r.totalDiscoveryTokens,r.totalReadTokens):lt(r.totalDiscoveryTokens,r.totalReadTokens)}var fs=kt.default.join((0,Pt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function bs(){try{return new q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Ft.unlinkSync)(fs)}catch(e){e instanceof Error?_.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):_.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return _.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function hs(r,e){return e?Nt(r):ut(r)}function Ss(r,e,t,s,n,o,i){let a=[],d=ue(e);a.push(...Ct(r,d,s,i));let u=t.slice(0,s.sessionCount),c=Ke(u,t),E=Ee(e,c),g=Je(e,s.fullObservationCount);a.push(...Mt(E,g,s,n,i));let p=t[0],f=e[0];yt(s,p,f)&&a.push(...Ut(p,i));let h=pe(e,s,o,n);return a.push(...xt(h,i)),a.push(...wt(d,s,i)),a.join(`
`).trimEnd()}async function be(r,e=!1){let t=_e(),s=r?.cwd??process.cwd(),n=oe(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=bs();if(!a)return"";try{let d=o.length>1?qe(a,o,t):ce(a,i,t),u=o.length>1?Ve(a,o,t):me(a,i,t);return d.length===0&&u.length===0?hs(i,e):Ss(i,d,u,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
